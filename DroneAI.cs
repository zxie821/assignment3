...
//         if (ifMoveable)
//         {
//             if (Vector3.Distance(m_Drone.transform.position, my_goal_object.transform.position)<10f)
//             {
...
//         }else if(ifFinished)
//         {
//             m_Drone.Move_vect(mDecision.getMove(my_goal_object.transform.position));
//             return;
//         }
...
public class DroneAI : MonoBehaviour
{
    ...
    private HighResMap mHighResMap;
    public GameObject[] friends; // use these to avoid collisions
    private DroneDecisionSimple mDecision;
    private bool ifMoveable;
    private bool ifFinished;
    private int myIndex;
    private void Start()
